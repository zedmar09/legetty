...
const ForgotPasswordPage: NextPage = () => {
  ...
  return (
    <div className="h-screen flex">
      ...
      <div className="px-6 lg:px-0 flex justify-center w-full mt-[15vh] md:w-1/2">
        <div className="md:max-w-[430px] mx-auto flex-grow">
          <Typography className="text-title1 sm:text-title0">Families</Typography>
